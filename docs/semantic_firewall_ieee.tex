...
\begin{enumerate}
    ...
    \item \textbf{Stateful Threat Hunting:} A multi-turn detection engine that computes an escalation trajectory across sessions, actively identifying ``Agent Avoidance'' tactics typical of advanced persistent threats.
