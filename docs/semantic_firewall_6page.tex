...
\textbf{Red Team Resilience.} Across 212 manual red team attacks (Table~\ref{tab:combined}d), the system achieves an overall 85.85\% resilience score. Breaking this down, the pipeline excels against Direct Injections (96.72\% blocked, 59/61) and Persona Adoption/DAN prompts (93.48\% blocked, 43/46). Base64/Hex obfuscation is caught at 87.80\% (36/41). Conversely, Multi-Turn Escalation (66.67\%, 20/30) and Hypothetical Academic Framing (70.59\%, 24/34) prove more challenging, primarily because these attacks avoid structural triggers and rely purely on semantic drift. This reaffirms the core thesis: heuristics alone lack context, and LLMs alone lack speed; both must be orchestrated. Furthermore, the 384-dimensional dense vectors map synonymous attacks closely, bounding adversarial cache evasion via simple linguistic perturbation (cosine similarity drops by only $\sim 0.04$--$0.08$).
